...
# Dataloading
parser.add_argument('--train_path', default="data/apps/train", type=str, help='path to training data')
...
parser.add_argument('--save-freq', default=2000, type=int, help='save model checkpoints after this number of training steps')
