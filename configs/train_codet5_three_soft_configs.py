...
parser.add_argument('--model', default="Salesforce/codet5p-770m-py", type=str, help='type of transformers model as model backbone')
parser.add_argument('--model_path', default=None, type=str, help='path to model backbone pretrained weights') 
parser.add_argument('--save_dir', type=str, help='path to save trained model checkpoints') 
...
parser.add_argument('--save-freq', default=500, type=int, help='save model checkpoints after this number of training steps')
parser.add_argument('--save_total_limit', default=10, type=int, help='total of number checkpoints to keep; only keep the latest ones') 
